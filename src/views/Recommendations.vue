<template>
  <b-container fluid class="main-view">
    <b-row class="my-2">
      <PlantCard v-for="name in plantNames" :key="name" :plantName="name"/>
    </b-row>
    <b-row class="my-2">
      <b-col> <b-button pill variant="dark" size="lg">+</b-button> </b-col>
      <b-col></b-col>
      <b-col></b-col>
      <b-col> <b-button variant="outline-dark" size="lg" @click="$router.push('/garden')">See Garden</b-button> </b-col>
    </b-row>
  </b-container>
</template>
